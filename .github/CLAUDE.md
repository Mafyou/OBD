...
- Structure recommandée :
  ...
  3. Public cible
  4. Appel à l'action
- Utiliser des emojis pour aérer le texte
- Inclure des mots-clés naturellement pour le référencement (ASO)

### Readme
- Mettre à jour le Readme du projet. Souvent à la racine du projet.
- Mettre à jour le Readme à racine de la solution.